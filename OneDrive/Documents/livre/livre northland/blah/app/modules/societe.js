...
/* Illustration de la vue d'ensemble — hébergée sur GitHub Pages (voir IMG_BASE).
   Le fichier local s'appelle « sociéte.png » ; en ligne c'est « societe.jpg » —
   sans accent (encodage d'URL) et en JPG (les PNG pesaient 3 Mo chacun). */
const SO_ILLUS=IMG_BASE+'societe.jpg';
...
const SO_FICHIERS={
  traditions:'tradition.jpg',
  noblesse:'hierarchie.jpg',
  education:'etudes.jpg',
  economie:'monaie.jpg',
  mode:'mode.jpg',
  gastronomie:'gastronomie.jpg',
  langues:'langue-et-ecriture.jpg'
};
